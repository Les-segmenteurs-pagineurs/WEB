<template>
    <div id="add_account">
        ...
        <form @submit.prevent="add_user">
         ...
         <input type="password" v-model="login">
         <input type="password2" v-model="login">
    ...
    setup() {
      ...
      add_user(async () => {
        try {
          ...
          const response = await axios.post('http://klebert-host.com:60513//get_login'); // Remplacez par l'URL correcte
